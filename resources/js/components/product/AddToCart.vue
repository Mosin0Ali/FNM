      ...
      <template v-if="!isLoading">
        ...
        <div class="d-flex fs-12">
          ...
          <div
            :class="[
              'ms-2',
              { 'ms-auto': generalSettings.conversation_system != 1 },
              { 'ms-auto': !is_addon_activated('multi_vendor') },
            ]"
          >
          ...
          <v-col cols="3" lg="2">
            <span class="border pa-2 lh-0 rounded d-inline-block">
              <router-link
                :to="{
                  name: 'Brand',
                  params: { brandId: productDetails.brand.id },
                }"
              >
                <img
        ...
        <div v-if="discount > 0" class="lh-1">
          <v-row>
            ...
            <v-col cols="9" lg="10" class="py-2 d-flex align-baseline">
              <del>
                <template
                  v-if="
                    productDetails.base_price !== productDetails.highest_price
                  "
                >
                  <span
                    class="d-inline-flex align-center fs-20 fw-500 opacity-50"
                  >
                    <span class="">{{
                    ...
                    <span class="">{{
                      format_price(productDetails.highest_price)
                    }}</span>
                  </span>
                </template>
                <template v-else>
                  <span class="fs-20 fw-500 opacity-60">{{
                    format_price(productDetails.base_price)
                  }}</span>
                </template>
              </del>
              <span v-if="productDetails.unit" class="fs-12 opacity-50 ms-1"
          ...
          <v-row>
            ...
            <v-col cols="9" lg="10" class="py-2">
              ...
              >
                <span
                  class="d-inline-flex align-center primary--text fs-24 fw-500"
                >
                  <span class="">{{
                  ...
                  <span class="mx-2">-</span>
                  <span class="">{{
                    format_price(productDetails.highest_discounted_price)
                  }}</span>
                </span>
              </template>
              <template v-else>
        ...
        <v-row class="mt-4 gutters-5">
          <v-col cols="12" sm="6">
            <div
              class="bg-soft-primary border border-primary rounded px-4 py-3 lh-1"
            >
              <div class="mb-3 d-flex align-center">
                <template v-if="stock">
                  <i
                    class="las la-check green rounded-circle size-15px fs-8 white--text d-inline-flex align-center justify-center me-3"
                  ></i>
          ...
          <v-col cols="12" sm="6">
            <div
              class="grey lighten-3 border-gray-300 rounded px-4 py-3 d-flex lh-1-3"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
              ...
              <div class="ms-3">
                <div class="fw-700 mb-3 text-truncate">
        ...
        <v-row
          v-if="
            !is_empty_obj(selectedVariation) && Number.isInteger(cartQuantity)
          "
        >
          <v-col cols="3" lg="2">
          ...
          <v-col cols="9" lg="10">
            <span class="primary--text fs-24 fw-600">{{
              format_price(selectedVariation.price * cartQuantity)
            }}</span>
          </v-col>
        </v-row>
        ...
        <div class="my-5">
          <v-text-field
            ...
            v-model="productAdditionalDetail"
          ></v-text-field>
        </div>
        <div class="my-5">
          <v-btn
  ...
  methods: {
    ...
    addCart() {
      ...
      this.addToCart({
        ...
        productAdditonalDetail: this.productAdditionalDetail,
      });
      this.snack({
